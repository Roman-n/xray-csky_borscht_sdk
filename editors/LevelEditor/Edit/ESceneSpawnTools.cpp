...
static LPCSTR xrse_factory_library	= "xrSE_FactoryG.dll";
...
{            
	PHelper().CreateFlag32(items, PrepareKey(pref,"Common\\Hide Attached Objects"),	&m_Flags,		flHideAttachedObjects);
