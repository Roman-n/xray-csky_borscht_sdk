...
void *stdmalloc(size_t size) { return malloc(size); }
void  stdfree(void *ptr) { free(ptr); }
...
struct ImGuiResizeGripDef
{
    ...
    ImGuiResizeGripDef(ImVec2 CornerPos, ImVec2 InnerDir, int AngleMin12, int AngleMax12)
    	: CornerPos(CornerPos), InnerDir(InnerDir), AngleMin12(AngleMin12), AngleMax12(AngleMax12)
    { }
};
