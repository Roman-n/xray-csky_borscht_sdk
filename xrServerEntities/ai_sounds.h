...
enum ESoundTypes {
	SOUND_TYPE_NO_SOUND					= 0x00000000ul,

	SOUND_TYPE_WEAPON					= 0x80000000ul,
	SOUND_TYPE_ITEM						= 0x40000000ul,
	SOUND_TYPE_MONSTER					= 0x20000000ul,
	SOUND_TYPE_ANOMALY					= 0x10000000ul,
	SOUND_TYPE_WORLD					= 0x08000000ul,

	SOUND_TYPE_PICKING_UP				= 0x04000000ul,
	SOUND_TYPE_DROPPING					= 0x02000000ul,
	SOUND_TYPE_HIDING					= 0x01000000ul,
	SOUND_TYPE_TAKING					= 0x00800000ul,
	SOUND_TYPE_USING					= 0x00400000ul,

	SOUND_TYPE_SHOOTING					= 0x00200000ul,
	SOUND_TYPE_EMPTY_CLICKING			= 0x00100000ul,
	SOUND_TYPE_BULLET_HIT				= 0x00080000ul,
	SOUND_TYPE_RECHARGING				= 0x00040000ul,

	SOUND_TYPE_DYING					= 0x00020000ul,
	SOUND_TYPE_INJURING					= 0x00010000ul,
	SOUND_TYPE_STEP						= 0x00008000ul,
	SOUND_TYPE_TALKING					= 0x00004000ul,
	SOUND_TYPE_ATTACKING				= 0x00002000ul,
	SOUND_TYPE_EATING					= 0x00001000ul,

	SOUND_TYPE_IDLE						= 0x00000800ul,

	SOUND_TYPE_OBJECT_BREAKING			= 0x00000400ul,
	SOUND_TYPE_OBJECT_COLLIDING			= 0x00000200ul,
	SOUND_TYPE_OBJECT_EXPLODING			= 0x00000100ul,
	SOUND_TYPE_AMBIENT					= 0x00000080ul,
