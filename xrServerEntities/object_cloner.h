...
*/
	...
	{
		clone(
			const_cast<typename object_type_traits::remove_const<T1>::type&>(_1.first),
...
*/
	...
	struct CHelper4 {
		IC	static void clone(const T &_1, T &_2)
		{
			CHelper<T,object_type_traits::is_pointer<T>::value>::clone(_1,_2);
		}
	};
	...
	IC	static void clone(const T &_1, T &_2)
	{
		CHelper4<T,object_type_traits::is_stl_container<T>::value>::clone(_1,_2);
	}
};
