...
u32 get_file_age(ILocatorAPI* fs, LPCSTR nm)
{
...
/*		class_<FS_Path>("FS_Path")
		...
		class_<ILocatorAPI::file>("fs_file")
...
//			.def("append_path",							&ILocatorAPI::append_path)
			...
			.def("exist",								(bool	(ILocatorAPI::*)(LPCSTR)) (&ILocatorAPI::exist))
			.def("exist",								(bool	(ILocatorAPI::*)(LPCSTR, LPCSTR)) (&ILocatorAPI::exist))
